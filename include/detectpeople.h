#pragma once
    ...
    #include <pcl/common/transforms.h>
        ...
        template <typename PointT> class GroundBasedPeopleDetectionApp_M;
    
        template <typename PointT>
        class GroundBasedPeopleDetectionApp_M
        {
        public:
          ...
          /** \brief Constructor. */
          GroundBasedPeopleDetectionApp_M ();
    
          /** \brief Destructor. */
          virtual ~GroundBasedPeopleDetectionApp_M ();
          ...
          *
          * \param[in] voxel_size Value of the voxel dimension (default = 0.m.).
          */
         void
         ...
         /**
          * \brief Swap rows/cols dimensions of a RGB point cloud ( degrees counterclockwise rotation).
          *
